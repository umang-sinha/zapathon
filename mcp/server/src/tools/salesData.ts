...
export const SALES_TOOL_SCHEMA = {
  ...
  description:
    "Retrieves the top 'n' prospects to reach out to, optionally filtered by a specific vertical. Use this tool when the user asks for top prospects, prospects to reach out to, or similar queries that imply needing a list of leads.",
  inputSchema: {
    type: "object",
    properties: {
      vertical: {
      ...
      numberOfRecords: {
        ...
        type: "number",
        description:
          "The maximum number of top prospects to retrieve. Defaults to 10 if not specified.",
        default: 10,
      },
    },
...
export const getProspects = async (
  vertical = SALES_TOOL_SCHEMA.inputSchema.properties.vertical.default,
  numberOfRecords = SALES_TOOL_SCHEMA.inputSchema.properties.numberOfRecords
    .default
) => {
  try {
